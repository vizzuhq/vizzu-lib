...
class Highlighter {
  constructor(chart, animOptions) {
    ...
    this.defaultPalette = this.chart
      .getComputedStyle()
      .plot.marker.colorPalette.split(" ");
    ...
    if (colorchannels.length == 0) this.colorchannel = null;
      ...
      throw new Error(
        "charts with multiple color series are not supported by highlighter",
      );
  }
  ...
  highlight(dataseries, categories) {
    if (this.colorchannel && dataseries != this.colorchannel) {
      throw new Error(
        "Color channel must be empty or match the data series to be selected",
      );
    }
