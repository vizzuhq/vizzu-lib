...
const testSteps = [
  ...
  (chart) => {
    ...
    chart._call(chart.module._vizzu_pointerMove)(chart.render.ccanvas.id, 0, 300, 250)
    chart._call(chart.module._vizzu_pointerUp)(chart.render.ccanvas.id, 0, 300, 250)
    return chart.anim
  }
]
