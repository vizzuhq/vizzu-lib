...
describe("getConfig()", () => {
    describe("configPathList", () => {
        test("if configPathList is no an array, err is thrown", () => {
            return expect(TestCasesConfig.getConfig()).rejects.toThrow("Assert failed: configPathList is array");
        });
    ...
    describe("configPath", () => {
        test("if configPath name is not string, err is thrown", () => {
            return expect(TestCasesConfig.getConfig([
                []
            ])).rejects.toThrow("The \"path\" argument must be of type string. Received an instance of Array");
        });
