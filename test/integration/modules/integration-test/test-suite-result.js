      ...
      if (
        ...
        for (const [key, value] of Object.entries(testCasesConfig)) {
          ...
          let conFigPath = path.join(
            ...
            path.relative(TestEnv.getTestSuitePath(), path.join(TestEnv.getWorkspacePath(), key)),
          ...
          Promise.all([rmReady, mkdirReady]).then(() => {
            ...
            let formattedConfigDataReady = prettier.format(JSON.stringify(configData, null, 2), {
              parser: 'json',
              tabWidth: 2
            })
