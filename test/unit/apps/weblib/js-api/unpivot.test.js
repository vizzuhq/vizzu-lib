...
describe('UnPivot.convert(data)', () => {
    ...
    describe('1D', () => {
        ...
        test('convert_1D_1 - measures = list', () => {
            expect(JSON.stringify(UnPivot.convert(Data1D['data_1d_1'].input).series))
            .toMatch(JSON.stringify(Data1D['data_1d_1'].output.series));
        });

        test('convert_1D_2 - measures = object', () => {
            expect(JSON.stringify(UnPivot.convert(Data1D['data_1d_2'].input).series))
            .toMatch(JSON.stringify(Data1D['data_1d_2'].output.series));
        });

        test('convert_1D_3 - data.dimensions.item.type = undefined', () => {
            expect(JSON.stringify(UnPivot.convert(Data1D['data_1d_3'].input).series))
            .toMatch(JSON.stringify(Data1D['data_1d_3'].output.series));
        });

        test('convert_1D_3 - data.dimensions.item.type = null', () => {
            expect(JSON.stringify(UnPivot.convert(Data1D['data_1d_4'].input).series))
            .toMatch(JSON.stringify(Data1D['data_1d_4'].output.series));
        });

        test('convert_1D_4 - data.dimensions.item.type = dimension', () => {
            expect(JSON.stringify(UnPivot.convert(Data1D['data_1d_5'].input).series))
            .toMatch(JSON.stringify(Data1D['data_1d_5'].output.series));
        });
    });
    ...
    describe('3D', () => {
        ...
        test('convert_3D_1', () => {
            expect(JSON.stringify(UnPivot.convert(Data3D['data_3d_1'].input).series))
            .toMatch(JSON.stringify(Data3D['data_3d_1'].output.series));
        });
    });
});
